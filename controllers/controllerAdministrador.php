...
if(isset($_SERVER['REQUEST_METHOD'])){
    ...
    if($_SERVER['REQUEST_METHOD']==='POST'){
        if(isset($_POST['actualizar'])){
            ...
            if($_GET['tipo']=="cliente"){
               ...
               // echo "estamos aqui";
                ...
                //$obj=null;
               // $ctrl=null;
                header("location:http://localhost/ccopita/admin-tabla-clientes.php");
            }
        }
        ...
        if($_GET['action']=="salir"){
             ...
             * redirigiendo 
             */
            header("location:http://localhost/ccopita/index.html");
            ...
            header("location:http://localhost/ccopita/add-table-cliente.php");
            ...
            header("location:http://localhost/ccopita/info-tabla-cliente.php?idCliente=".$_GET['idPeople']);
