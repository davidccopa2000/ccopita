    ...
    */
    if($_SERVER['REQUEST_METHOD']==='POST'){
        ...
        if(!$obj){
             ...
             */
            header("location:http://localhost/ccopita/login.html");
            ...
            header("location:http://localhost/ccopita/administrador.php");
             ...
             */
            header("location:http://localhost/ccopita/");
         ...
         */
        header("location:http://localhost/ccopita/404.html");
    }
}else{
